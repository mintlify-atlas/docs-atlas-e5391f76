...
<ParamField path="mod" type="mapped_module&">
...
<ParamField path="h" type="handle">
  Handle to the new thread
</ParamField>

<ParamField path="thr" type="emulator_thread&">
...
<ParamField path="current_thread" type="emulator_thread&">
  Thread being switched away from
</ParamField>

<ParamField path="new_thread" type="emulator_thread&">
